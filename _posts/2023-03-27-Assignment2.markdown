...
## A significant drop in Drug/narcotic crime in San Francisco from 2003 to 2018.
...
This dataset has the information about the crime incidents in San Francisco from 2003 to 2018, and the scape of this dataset is more than two millions.
The information of the crime recorded includes category, exact time, location and so on. This article concerns about
the number of drug/narcotic crimes from 2003 to 2018. 
